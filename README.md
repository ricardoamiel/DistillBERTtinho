...
| GPU latency, batch 1 (ms) | 4.25 | 2.57 | 1.65x |
| CPU latency, batch 1 (ms) | 62.7 | 34.5 | 1.82x |
| Throughput, batch 32 (samples/s) | 914 | 1830 | 2.00x |
| Peak GPU memory, training (MiB) | 2701 | 1518 | 1.78x |
| Peak GPU memory, inference (MiB) | 640 | 475 | 1.35x |
| Training wall clock, all datasets (min) | 11 | 7 | 1.58x |
